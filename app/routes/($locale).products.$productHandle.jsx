...
export default function Product() {
  ...
  return (
    <>
      <div className=' ' style={{background: "linear-gradient(180deg, rgba(48,133,189,1) 0%, rgba(39,45,106,1) 100%)", marginTop: "150px", color: "#fff"}}>
        <div className='container text-center'>
          <div className='relative'>
            ...
            <h1 className='uppercase m-0 font-bold'>BARIATRICS</h1>
          </div>
          <p className='uppercase mb-6 -mt-4 font-bold'>for Retail</p>
          <p className='font-bold'>Reliable, Soft, And Breathable Materials</p>
          ...
          <p>With a liquid capacity of 2500 ml and a range of sizes that fits up to 5XL, Dignex Bariatric Briefs are perfect for those who need maximum absorbency. Day in and day out, you'll have the protection and support you need with Dignex Bariatric Briefs.</p>
        </div>
      </div>
      <Section className="px-0 md:px-8 lg:px-12 text-gray-700">
          ...
          <div className="sticky md:-mb-nav md:top-nav md:-translate-y-nav md:h-screen md:pt-nav hiddenScroll">
            <section className="flex flex-col w-full max-w-xl gap-8 p-6 md:mx-auto md:max-w-sm md:px-0">
              <div className="grid gap-2">
                <Heading as="h1" className="whitespace-normal mb-0">
                  {title}
                </Heading>
                {/* {vendor && (
      ...
      <Section className="px-0 md:px-8 lg:px-12">
        <div className='flex justify-center'>
          <h2 className='text-3xl product-h font-bold'>About Our Product</h2>
        </div>
    ...
    <>
      {options
        ...
        .map((option) => (
          ...
          >
            <Heading as="legend" size="lead" className="min-w-[4rem] font-normal mb-2">
              {option.name}
            </Heading>
                      ...
                      <Text key={id}>
                        <ProductOptionLink
                          ...
                          className={clsx(
                            ...
                            'leading-none py-1 border-[3px] py-3 px-7 rounded-md cursor-pointer option transition-all duration-200',
                            checked ? 'border-primary/50 option-selected' : 'border-primary/0',
                          )}
                        />
                      </Text>
                    );
